 ...
 *
 * @package    dpd_2015
 * @subpackage dpd_2015/classes
 */

class dpd_2015_Sanitize {
	...
	public function clean() {
		 ...
		 */
		do_action( 'dpd_2015_pre_sanitize', $sanitized );
		 ...
		 */
		do_action( 'dpd_2015_post_sanitize', $sanitized );
	...
	public function set_type( $type ) {
		...
		if ( empty( $type ) ) {
			...
			$check = new WP_Error( 'forgot_type', __( 'Specify the data type to sanitize.', 'dpd-2015' ) );

		}

		if ( is_wp_error( $check ) ) {

			wp_die( $check->get_error_message(), __( 'Forgot data type', 'dpd-2015' ) );
